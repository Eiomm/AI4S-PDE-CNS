...
class ReActWorkflow(BaseWorkflow):
        ...
        *,
        ...
        for step in range(self.max_steps):
            ...
            if turn_result.next_user_message is not None:
                context_manager.add_assistant_reply(self._build_protocol_violation_placeholder())
    ...
    @staticmethod
    def _build_protocol_violation_placeholder() -> str:
        return (
            "<Think>The previous assistant reply violated the ReAct protocol and "
            "was ignored by the runtime.</Think>\n"
            "<Action>\n"
            "```python\n"
            "# Protocol violation placeholder. No code was executed from the ignored reply.\n"
            "```\n"
            "</Action>"
        )
