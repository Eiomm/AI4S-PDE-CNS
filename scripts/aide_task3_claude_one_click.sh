...
MAX_ITERATIONS="${AI4S_TASK3_MAX_ITERATIONS:-8}"
...
RUN_ROOT="$OUTPUTS_DIR/aide_task3_claude/$STAMP"
...
ln -sfn "$RUN_ROOT" "$OUTPUTS_DIR/aide_task3_claude/latest"
...
PYTHONUNBUFFERED=1 \
"$PY" scripts/run_ai4s_aide_task.py 3 \
  --model "$MODEL" \
